...
const teamData = {
  2024: [
    ...
    { src: 'images/team_photos/2023team/emma.JPG', text: 'Emma Lim', role: 'Events Director', path: '/' },
    { src: 'images/team_photos/2021team/mike.jpg', text: 'Michael Tham', role: 'Digital Coordinator', path: '/' },
  ],
  2023: [
    ...
    { src: 'images/team_photos/2022team/el.JPG', text: 'Elisabeth Chew', role: 'Events Director', path: '/' },
