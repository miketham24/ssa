import React__default, { useContext, useEffect, useState, useRef, useMemo, createElement, Fragment, Component, createContext } from 'react';
...
var CookiesContext = createContext(new Cookies());
...
var CookiesProvider = /** @class */ (function (_super) {
    ...
    CookiesProvider.prototype.render = function () {
        return createElement(Provider, { value: this.cookies }, this.props.children);
    };
...
function Tree2Element(tree) {
  return tree && tree.map(function (node, i) {
    return createElement(node.tag, __assign$2({
      key: i
...
function GenIcon(data) {
  return function (props) {
    return createElement(IconBase, __assign$2({
...
function IconBase(props) {
  var elem = function (conf) {
    ...
    var attr = props.attr,
        title = props.title,
        svgProps = __rest$2(props, ["attr", "title"]);

    return createElement("svg", __assign$2({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
...
var main_2 = main.BrowserView;
var main_3 = main.ConsoleView;
var main_4 = main.CustomView;
var main_5 = main.IEView;
var main_6 = main.IOSView;
var main_7 = main.MobileOnlyView;
var main_8 = main.MobileView;
var main_9 = main.SmartTVView;
var main_10 = main.TabletView;
var main_11 = main.WearableView;
var main_12 = main.WinPhoneView;
var main_13 = main.browserName;
var main_14 = main.browserVersion;
var main_15 = main.deviceDetect;
var main_16 = main.deviceType;
var main_17 = main.engineName;
var main_18 = main.engineVersion;
var main_19 = main.fullBrowserVersion;
var main_20 = main.getUA;
var main_21 = main.isAndroid;
var main_22 = main.isBrowser;
var main_23 = main.isChrome;
...
var styles = {
    bannerCard: {
        ...
        margin: "auto",
        textAlign: "center",
        width: main_35 ? "90%" : "500px",
        height: main_35 ? "450px" : "400px",
        maxWidth: 500,
        zIndex: 2147483647,
        padding: 0,
        fontFamily: "inherit",
        borderRadius: main_35 ? 0 : 6,
        backgroundColor: "#FFF",
    ...
    animationStyles: function (_a) {
        var showAnimation = _a.showAnimation, animateInDuration = _a.animateInDuration, animateOutDuration = _a.animateOutDuration;
        var duration = showAnimation ? animateInDuration : animateOutDuration;
        var animationName = showAnimation ? "fadein" : "fadeout";
        var animation = animationName + " " + duration + "ms";
        return {
...
var Announcement = function (_a) {
    var title = _a.title, subtitle = _a.subtitle, imageSource = _a.imageSource, buttonText = _a.buttonText, daysToLive = _a.daysToLive, secondsBeforeBannerShows = _a.secondsBeforeBannerShows, closeIconSize = _a.closeIconSize, animateInDuration = _a.animateInDuration, animateOutDuration = _a.animateOutDuration, onBannerClick = _a.onBannerClick;
    var _b = useCookies(["banner"]), cookies = _b[0], setCookie = _b[1];
    var _c = useState(false), showBanner = _c[0], setShowBanner = _c[1];
    var _d = useState(true), showAnimation = _d[0], setShowAnimation = _d[1];
    var today = new Date();
    var expirationDate = new Date();
    expirationDate.setDate(today.getDate() + (daysToLive !== undefined ? daysToLive : 5));
    var secondsBeforeBanner = secondsBeforeBannerShows !== undefined
    ...
    return showBanner ? (createElement(Fragment, null,
        createElement("div", { style: styles.overlay, onClick: fadeOut }),
        createElement("style", { children: animationKeyframes }),
        createElement("div", { style: __assign(__assign({}, styles.bannerCard), styles.animationStyles({
                showAnimation: showAnimation,
                animateInDuration: animateInDuration,
                animateOutDuration: animateOutDuration
            })) },
            createElement("img", { onClick: function (e) {
                    onBannerClick(e);
                }, style: styles.imageStyle, src: imageSource, alt: "Banner" }),
            createElement("div", { onClick: function (e) {
                    onBannerClick(e);
                }, style: styles.textWrapper },
                createElement("h3", { style: styles.titleStyle }, title),
                createElement("p", { style: styles.subtitleStyle }, truncate(subtitle)),
                createElement("div", { style: styles.button },
                    createElement("span", null, buttonText))),
            createElement(FiX, { color: "#FFFFFF", style: styles.closeIcon, size: closeIconSize, onClick: fadeOut })))) : null;
};
