...
var Announcement = function (_a) {
    ...
    var _c = React.useState(false), showBanner = _c[0], setShowBanner = _c[1];
    var _d = React.useState(true), showAnimation = _d[0], setShowAnimation = _d[1];
    var today = new Date();
    ...
    return showBanner ? (React.createElement(React.Fragment, null,
        React.createElement("div", { style: styles.overlay, onClick: fadeOut }),
        React.createElement("style", { children: animationKeyframes }),
        React.createElement("div", { style: __assign(__assign({}, styles.bannerCard), styles.animationStyles({
            ...
            React.createElement("div", { onClick: function (e) {
                ...
                React.createElement("h3", { style: styles.titleStyle }, title),
                React.createElement("p", { style: styles.subtitleStyle }, truncate(subtitle)),
                React.createElement("div", { style: styles.button },
                    React.createElement("span", null, buttonText))),
            React.createElement(FiX, { color: "#FFFFFF", style: styles.closeIcon, size: closeIconSize, onClick: fadeOut })))) : null;
};
